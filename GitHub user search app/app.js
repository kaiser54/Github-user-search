...
btn.addEventListener('click', function() {
    const url = `http://api.github.com/users/${input.value}`;
    async function getUrl() {
        ...
        githubBio.innerHTML = data.bio === "" || data.bio === null ? "This profile has no bio..."  : data.bio;
...
const toggleColorButton = document.querySelectorAll(".color-mode__btn");
toggleColorButton.forEach((btn) =>(
